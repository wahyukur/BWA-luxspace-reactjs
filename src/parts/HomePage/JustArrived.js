      ...
      <div className="overflow-x-hidden px-4" id="carousel">
        ...
        <div className="flex -mx-4 flex-row relative">
          ...
          <div className="px-4 relative card group">
            ...
            >
              <div
                className="absolute opacity-0 group-hover:opacity-100 transition duration-200 flex items-center justify-center w-full h-full bg-black/30"
              >
                <div
            ...
            <a href="/categories/1" className="stretched-link">
              {/* <!-- fake children --> */}
            </a>
          </div>
